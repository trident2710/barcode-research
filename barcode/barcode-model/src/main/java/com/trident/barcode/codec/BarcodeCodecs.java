...
import com.trident.barcode.reedsolomon.ReedSolomonIntermediateCodeStrategy;
import com.trident.barcode.reedsolomon.SBRSPIntermediateCodeStrategy;
...
public final class BarcodeCodecs {
    ...
    public static BarcodeCodec BASE_59_SIMPLE = new BarcodeCodecImpl(
            new BarcodeEncoderImpl(BarcodeDictionaries.BASE_59, new SimpleIntermediateCodeStrategy()),
